...
# prefixo = # df.to_csv(f"{prefixo}.csv", index=False) usando o "caracter" como "inventario_totais" ou "inventario_fornecedores" ou "inventario_acima60" 
# # df.to_excel(f"{prefixo}.csv", index=False) usando o "caracter" como "inventario_totais" ou "inventario_fornecedores" ou "inventario_acima60" 
# # Transforma ele em csv ou xlsx de cada propósito
